           ...
           <Row className='row'>
            ...
            <>
              <Col className='col' lg={12} md={12} sx={12} sm={12}>
                <img className='col-img' src={elem.product_img2} alt="images" />
            </Col>
            <Col className='col' lg={12} md={12} sx={12} sm={12}>
                <img className='col-img' src={elem.product_img3} alt="images" />
            </Col>
            <Col className='col' lg={12} md={12} sx={12} sm={12}>
                <img className='col-img' src={elem.product_img4} alt="images" />
            </Col>
            </>
            )}
           </Row>
